...
import { COST_STATUSES, COST_TYPES, EXPENSE_CATEGORIES, PAYMENT_METHODS } from "@/lib/constants";
import { formatDate, yen } from "@/lib/format";
import { removeCost, useDB } from "@/lib/store";
import type { Cost, CostStatus, CostType } from "@/lib/types";
              ...
              return (
                <div key={c.id} className="rounded-2xl border border-neutral-200/80 bg-white p-4 shadow-card">
                  ...
                  <div className="mt-2.5 flex items-end justify-between">
                    ...
                    <Money value={c.amount} className="text-base" />
                  </div>
