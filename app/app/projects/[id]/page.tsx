...
import { formatDate, pct1, shortDate, yen } from "@/lib/format";
import {
  removeCost,
  removeProject,
  removeRevenue,
...
import type { Cost, CostType, ProjectStatus, Revenue } from "@/lib/types";
            ...
            <div className="divide-y divide-neutral-50">
              {items.map((c) => (
                <div key={c.id} className="flex items-center gap-3 px-3 py-2.5">
                  ...
                  <Money value={c.amount} className="w-24 text-right text-[13px]" />
                  ...
                  <div className="mt-3 space-y-2">
                    {[
                      ...
                      >
                        ...
                        <Money value={row.value} className="text-xs" />
                      </button>
                    ))}
                    {fin.unpaidCost > 0 ? (
              ...
              <div className="divide-y divide-neutral-50">
                {revenues.map((r) => (
                  <div key={r.id} className="flex items-center gap-3 px-3 py-2.5">
                    ...
                    <Money value={r.amount} className="w-24 text-right text-[13px]" />
                    <div className="flex shrink-0 gap-0.5">
                      <button
                        type="button"
              ...
              <div className="divide-y divide-neutral-50">
                {estimates.map((e) => (
                  ...
                  >
                    ...
                    <Money value={e.total} className="w-24 text-right text-[13px]" />
                  </Link>
                ))}
              </div>
            )}
              ...
              <div className="divide-y divide-neutral-50">
                {invoices.map((inv) => (
                  ...
                  >
                    ...
                    <Money value={inv.total} className="w-24 text-right text-[13px]" />
                  </Link>
                ))}
              </div>
            )}
